...
window.readNumbers = function (txtsrc, txtout) {
    ...
    if (sout.search("NaN") != -1 || sout1.search("NaN") != -1) {
        ...
        txtout.val(sout.toUpperCase() + " " + sout1.toUpperCase());
    }
};

window.IDreadThousand = function (n, dg, snum, thousandDesc) {
    var s = "";
...
window.readAll = function (x, lang) {
    var s = "";
    var i = 0;
    var isfailed = false;
    ...
    if (isfailed == false) {
        do {
            ...
            if (lang == "id") {
                if (groupNumbers != 0) {
                    s =
                        IDreadThousand(groupNumbers, i, snum, thousandDesc) +
                        thousandDesc[i] +
                        " " +
                        s;
                }
...
window.terbilang = function (options) {
    var txtsrc;
    ...
    var readAll = function (x, lang) {
        ...
        if (isfailed == false) {
            do {
                var groupNumbers = Math.round(
                    (Math.floor(x) / 1000 - Math.floor(Math.floor(x) / 1000)) *
                        1000
                );
                if (lang == "id") {
                    if (groupNumbers != 0) {
