        ...
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" id="tab-detail" role="tabpanel">
                ...
                <div class="text-center">
                    <a href="{{ route('skbn.create') }}" class="btn-ajukan">
                        Ajukan
                    </a>
                </div>
            </div>
                ...
                <div class="container rounded-3 px-4 py-2" style="background:rgba(174,160,122,.25)">
                    @forelse($sedangProses as $pengajuan)
                        @php
                            ...
                            $alias  = $pengajuan->jenisSurat ?? 'skbn';
            ...
            {{-- Form global untuk hapus Skbn (akan diisi otomatis oleh komponen) --}}
            <form id="formHapusSkbn"
                method="POST"
                data-action-template="{{ route('skbn.hapus', ['id' => '__ID__']) }}">
                @csrf
                {{-- hidden "id" akan dibuat/diisi otomatis oleh komponen saat modal dibuka --}}
            </form>
            <x-btn-hapus
                modalId="modalHapusSkbn"
                formId="formHapusSkbn"
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const STORAGE_KEY = 'lastOpenedTabSkbn';
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const submit  = document.getElementById('btnHapusSkbn');
