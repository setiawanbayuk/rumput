...
@section('content')
    ...
    @push('scripts')
        ...
        <script>
            ...
            // function handleNaikLurah(e) {
            //     console.log(e);
            //     let url = "{{ route('skbn.naikLurah', ':id') }}"; // route baru
            //     url = url.replace(':id', e);
            ...
            //                 stopOnFocus: true,
            //                 style: {
            //                     background: "rgba(255, 193, 7, 1)", // warna kuning untuk "Naik ke Lurah"
            //                 },
            //             }).showToast();
            //             $('#tableSurat').DataTable().ajax.reload();
            //         },
