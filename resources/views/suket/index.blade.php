            ...
            <div class="col-md-12 d-flex align-items-center justify-content-between">
                @if (auth()->user()->role_id == 8)
                    <h6 class="text-muted mb-0">
                        Daftar pengajuan surat keterangan warga <b>RT {{ $rt }}/RW {{ $rw }}, Kelurahan {{ $kelurahan }}.</b>
                    </h6>
                ...
                @else
                    <h6 class="text-muted mb-0">
                        Daftar pengajuan surat keterangan warga <b>Kelurahan {{ $kelurahan }}.</b>
                    </h6>
                @endif
                <div class="d-flex gap-2">
                    @if (auth()->user()->role_id == 1 || auth()->user()->role_id == 8 || auth()->user()->role_id == 9)
                        <a class="btn btn-primary btn-sm shadow-sm" style="border-radius: 6px" href="{{ route('suket.add') }}">
