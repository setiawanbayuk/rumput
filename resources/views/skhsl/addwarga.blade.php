{{-- resources/views/tambahWarga/addwarga.blade.php (SKHSL) --}}
@extends('layouts.create')

@section('title', $title ?? 'Tambah Surat Keterangan Penghasilan')
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="card border-0 shadow-sm rounded-3"
                        ...
                        <div class="card-body">
                            <form id="formSkhsl" method="POST" enctype="multipart/form-data"
                                action="{{ route('skhsl.save') }}">
                                @csrf
                                <input type="hidden" id="nik" name="nik" value="{{ auth()->user()->nik }}">

                                {{-- ========== ROW: Dua Card Kiri-Kanan (Info Anak & Sekolah / Peruntukan & Pengantar) ========== --}}
                                <div class="row g-3" style="min-height: 500px">

                                    {{-- ===== KIRI: Data Penghasilan & Anak ===== --}}
                                    <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="penghasilan"
                                                        class="col-md-3 col-form-label ms-4">Penghasilan (Rp.)</label>
                                                    <div class="col-md-8">
                                                        <input id="penghasilan" type="number" min="0"
                                                ...
                                                <div class="row mb-3">
                                                    <label for="terbilang"
                                                        class="col-md-3 col-form-label ms-4">Terbilang</label>
                                                    <div class="col-md-8">
                                                        <input id="terbilang" type="text"
                                                            class="form-control @error('terbilang') is-invalid @enderror"
                                                            name="terbilang" value="{{ old('terbilang') }}">
                                                        @error('terbilang')
                                                            <span class="invalid-feedback"
                                                                role="alert"><strong>{{ $message }}</strong></span>
                                                        @enderror
                                                ...
                                                {{-- Nama Anak --}}
                                                <div class="row mb-3">
                                                    <label for="kepada" class="col-md-3 col-form-label ms-4">Nama
                                                        Anak</label>
                                                    <div class="col-md-8">
                                                ...
                                                {{-- Jenis Kelamin Anak --}}
                                                <div class="row mb-3">
                                                    <label for="kepada_gender" class="col-md-3 col-form-label ms-4">Jenis
                                                        Kelamin Anak</label>
                                                    <div class="col-md-8">
                                                        <select
                                                ...
                                                <div class="row mb-3">
                                                    <label for="kepada_hubungan"
                                                        class="col-md-3 col-form-label ms-4">Hubungan Dengan Wali</label>
                                                    <div class="col-md-8">
                                                        <select
                                                            ...
                                                            <option value=""></option>
                                                            <option value="Putranya" @selected(old('kepada_hubungan') === 'Putranya')>Putranya
                                                            </option>
                                                            <option value="Putrinya" @selected(old('kepada_hubungan') === 'Putrinya')>Putrinya
                                                            </option>
                                                            <option value="Cucunya" @selected(old('kepada_hubungan') === 'Cucunya')>Cucunya
                                                            </option>
                                                            <option value="Keluarga" @selected(old('kepada_hubungan') === 'Keluarga')>Keluarga
                                                            </option>
                                                        </select>
                                    ...
                                    {{-- ===== KANAN: Sekolah + Peruntukan + Pengantar ===== --}}
                                    <div class="col-md-6">
                                        <div class="card h-100 border-1 shadow-sm">
                                            <div class="card-body">
                                                ...
                                                {{-- Nama Sekolah --}}
                                                <div class="row mb-3">
                                                    <label for="kepada_sekolah" class="col-md-3 col-form-label ms-2">Nama
                                                        Sekolah</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="kepada_kelas"
                                                        class="col-md-3 col-form-label ms-2">Kelas/Semester</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="kepada_alamat_sekolah"
                                                        class="col-md-3 col-form-label ms-2">Alamat Sekolah</label>
                                                    <div class="col-md-8">
                                                ...
                                                {{-- Peruntukan & Pengantar (komponen reuse) --}}
                                                <x-peruntukan>
                    ...
                    {{-- Modal Konfirmasi --}}
                    <x-confirm-ajukan modalId="modalSkhsl" formId="formSkhsl"
