                        ...
                        <div class="card-body">
                            <form id="formEditSktm" method="POST" enctype="multipart/form-data" 
                                ...
                                <div class="d-flex justify-content-center gap-3" style="margin-top:75px;">
                                    <a href="{{ route('sktm.warga') }}" class="btn btn-secondary px-4 py-2 rounded-3">
                                        Batal
                                    </a>
                                    <button type="button" class="btn btn-primary px-4 py-2 rounded-3 fw-semibold" data-bs-toggle="modal" data-bs-target="#modalEditSktm">
                                        Update
                                    </button>
                                </div>
                            </form>
