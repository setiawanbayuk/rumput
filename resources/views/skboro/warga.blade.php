...
@section('content')
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                const modalEl = document.getElementById('modalHapusSkboro');
                const modal   = new bootstrap.Modal(modalEl);
                const form    = document.getElementById('formHapusSkboro');
                const submit  = document.getElementById('btnHapusSkboro');
