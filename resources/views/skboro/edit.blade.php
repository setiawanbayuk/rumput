    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                checkNIK();
                $("#provinsi_boro").select2("trigger", "select", {
                    data: {
                        id: '{{ $suratKeterangan->prov_boro }}',
                        text: '{{ $suratKeterangan->prov_boro_nm }}',
                    },
                });
                $("#kabko_boro").select2("trigger", "select", {
                    data: {
                        id: '{{ $suratKeterangan->kabko_boro }}',
                        text: '{{ $suratKeterangan->kabko_boro_nm }}',
                    },
                });
                $("#kecamatan_boro").select2("trigger", "select", {
                    data: {
                        id: '{{ $suratKeterangan->kec_boro }}',
                        text: '{{ $suratKeterangan->kec_boro_nm }}',
                    },
                });
                $("#kelurahan_boro").select2("trigger", "select", {
                    data: {
                        id: '{{ $suratKeterangan->kel_boro }}',
                        text: '{{ $suratKeterangan->kel_boro_nm }}',
                    },
                });
            });
        </script>
