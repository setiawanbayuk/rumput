        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card shadow-sm border-0 rounded-4">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('skkematian.store') }}">
                            @csrf
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input id="no_dokumen_perjalanan" type="number"
                                                                ...
                                                                name="no_dokumen_perjalanan" value="{{ old('no_dokumen_perjalanan') }}"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="tgl_kematian" type="date"
                                                        ...
                                                        name="tgl_kematian" value="{{ old('tgl_kematian') }}"
                                                ...
                                                <div class="col-md-4">
                                                    <input id="jam_kematian" type="time"
                                                        ...
                                                        name="jam_kematian" value="{{ old('jam_kematian') }}"
