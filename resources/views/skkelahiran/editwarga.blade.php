                        ...
                        <div class="card-body">
                            <form id="formEditSkkelahiran" method="POST" enctype="multipart/form-data" 
                                ...
                                <div class="d-flex justify-content-center gap-3 mb-3">
                                    <a href="{{ route('skkelahiran.warga') }}" class="btn btn-danger py-2 px-4 me-2" style="border-radius: 8px">
                                        Batal
                                    </a>
                                    <button type="button" class="btn text-white py-2 px-4"
                                            style="background: #7896B2; border-radius: 8px;" data-bs-toggle="modal" data-bs-target="#modalEditSkkelahiran">
                                        Update
                                    </button>
                                </div>
                            </form>
