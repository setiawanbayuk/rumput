        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card shadow-sm border-0 rounded-4">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('skkelahiran.store') }}">
                            @csrf
                                                ...
                                                <div id="data-pelapor" name="data-pelapor">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="nik_pelapor"
                                                            class="col-md-3 col-form-label text-md-start ms-2">{{ __('NIK Pelapor') }}</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="no_dokumen_perjalanan"
                                                            class="col-md-3 col-form-label text-md-start ms-2">{{ __('No. Dokumen Perjalanan') }}</label>

                                                        <div class="col-md-8">
                                                            <input id="no_dokumen_perjalanan" type="number"
                                                                class="form-control @error('no_dokumen_perjalanan') is-invalid @enderror"
                                                                name="no_dokumen_perjalanan"
                                                                value="{{ old('no_dokumen_perjalanan') }}"
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="kk_pelapor"
                                                            class="col-md-3 col-form-label text-md-start ms-2">{{ __('No. KK Pelapor') }}</label>

                                                        <div class="col-md-8">
                                                            <input id="kk_pelapor" type="number"
                                                                class="form-control @error('kk_pelapor') is-invalid @enderror"
                                                                name="kk_pelapor" value="{{ old('kk_pelapor') }}"
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="name_pelapor"
                                                            class="col-md-3 col-form-label text-md-start ms-2">{{ __('Nama Pelapor') }}</label>

                                                        <div class="col-md-8">
                                                            <input id="name_pelapor" type="text"
                                                                class="form-control @error('name_pelapor') is-invalid @enderror"
                                                                name="name_pelapor" value="{{ old('name_pelapor') }}"
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="kewarganegaraan_pelapor"
                                                            class="col-md-3 col-form-label text-md-start ms-2">{{ __('Kewarganegaraan Pelapor') }}</label>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="kk_saksi1" type="number"
                                                                    ...
                                                                    name="kk_saksi1" value="{{ old('kk_saksi1') }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="name_saksi1" type="text"
                                                                    ...
                                                                    name="name_saksi1" value="{{ old('name_saksi1') }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="kk_saksi2" type="number"
                                                                    ...
                                                                    name="kk_saksi2" value="{{ old('kk_saksi2') }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="name_saksi2" type="text"
                                                                    ...
                                                                    name="name_saksi2" value="{{ old('name_saksi2') }}"
                                    ...
                                    <div class="card h-100 border-1 shadow-sm rounded-4"
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input id="name_anak" type="text"
                                                            ...
                                                            name="name_anak" value="{{ old('name_anak') }}"
                                            ...
                                            <div id="data-ortu" name="data-ortu">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input id="kk_ayah" type="number"
                                                            ...
                                                            name="kk_ayah" value="{{ old('kk_ayah') }}"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input id="name_ayah" type="text"
                                                            ...
                                                            name="name_ayah" value="{{ old('name_ayah') }}"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input id="tempat_lhr_ayah" type="text"
                                                            ...
                                                            name="tempat_lhr_ayah" value="{{ old('tempat_lhr_ayah') }}"
                                                ...
                                                <div class="card-header bg-transparent mb-3 text-center fw-bold">Data Ibu
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="nik_ibu"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input id="name_ibu" type="text"
                                                            ...
                                                            name="name_ibu" value="{{ old('name_ibu') }}"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input id="tempat_lhr_ibu" type="text"
                                                            ...
                                                            name="tempat_lhr_ibu" value="{{ old('tempat_lhr_ibu') }}"
