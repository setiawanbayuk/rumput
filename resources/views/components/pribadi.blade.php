        ...
        <div class="col-md-8">
            <div class="input-group">
                <input type="text"
                    ...
                    name="nik" placeholder="Masukkan 16 digit NIK" aria-label="NIK"
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            <input id="tgl_lhr" type="date"
                ...
                name="tgl_lhr" value="{{ old('tgl_lhr') }}" autocomplete="tgl_lhr"
                autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-8">
            <select class="form-control @error('pendidikan') is-invalid @enderror"
                id="pendidikan" name="pendidikan" data-placeholder="Pendidikan Terakhir">
            </select>
            @error('pendidikan')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
