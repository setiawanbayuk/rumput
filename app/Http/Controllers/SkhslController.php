...
class SkhslController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('skhsl.index', compact('title', 'rt', 'rw', 'kelurahan'));
    }
    ...
    public function warga()
    {
        ...
        return view('skhsl.warga', compact(
            'title',
            'nama',
            'nik',
            'surat',
    ...
    public function addwarga()
    {
        ...
        return view('skhsl.addwarga', compact('title', 'nik'));
    }
    ...
    public function updatewarga(Request $request, $id)
    {
        ...
        return redirect()->route('skhsl.warga')->with('success', 'Data berhasil diperbarui');
    }
