...
class SuketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('suket.index', compact('title', 'rt', 'rw', 'kelurahan'));
    }
    ...
    public function warga()
    {
        ...
        return view('suket.warga', compact(
            'title',
            'nama',
            'nik',
            'surat',
    ...
    public function add()
    {
        ...
        if (isset($template)) {
            ...
            // dd($var);
            return view('suket.add', compact('title', 'currentUser', 'no_urut_surat', 'var'));
        } else {
    ...
    public function edit($id)
    {
        ...
        if (isset($template)) {
            ...
            return view('suket.edit', compact('title', 'currentUser', 'suratKeterangan', 'var', 'var_value'));
        } else {
    ...
    public function preview($id)
    {
        ...
        $url = env('APP_URL', 'http://rumput.test') . '/verify/' . 'suket/' . $id;
        $data = [
        ...
        $outputPdf = hash('sha256', 'SUKET_' . $id);
    ...
    public function get(Request $request)
    {
        try {
            ...
            $query = SuratKeterangan::with(['history' => function ($q) {
    ...
    public function lihatNilai($id)
    {
        ...
        $log = Log_surat::where('tabel_surat', 'surat_keterangans')
            ->where('id_surat', $id)
